...
public:
	...
	SpotLight() {
		...
		spotLightCutoffStartDeg = 0;
		spotLightTotalWidthDeg = 0;
		CreateVisGeometry();
	}
	SpotLight(const glm::vec3 p, const glm::vec3 I, const glm::vec3 D, const float cutoffDeg, const float totalWidthDeg) {
		...
		spotLightCutoffStartDeg = cutoffDeg;
		spotLightTotalWidthDeg = totalWidthDeg;
		CreateVisGeometry();
	}
	...
	float GetSpotLightCutoffStartDeg() const { return spotLightCutoffStartDeg; }
	float GetSpotLightTotalWidthDeg() const { return spotLightTotalWidthDeg; }
...
private:
	...
	// -------------------------------------------------------
	glm::vec3 direction;
	float spotLightCutoffStartDeg;
	float spotLightTotalWidthDeg;
};
...
public:
	...
	// control the direction of directional light
